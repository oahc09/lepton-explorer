...
- Copy, cross-volume move, and redo all show a cancelable progress dialog (same-volume move is an instant rename). Cancel is honored between items; a single large folder isn't interrupted mid-copy.
