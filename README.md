...
![status](https://img.shields.io/badge/status-feature--complete-brightgreen) ![tests](https://img.shields.io/badge/tests-154%20passing-brightgreen) ![build](https://img.shields.io/badge/exe-windows%20x64-blue)
...
```bash
cd src-tauri && cargo test   # Rust unit tests (36)
pnpm test                    # frontend tests (118)
...
- Copy shows a progress dialog; move (typically an instant same-volume rename) and redo do not.
